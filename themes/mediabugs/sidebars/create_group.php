...
?>
			...
			<div id="create_group_sidebar" class="sidebar column_padding">
				<a href="#" onclick="$('create_group').style.display='block'; this.style.display='none'; return false;">Create a Group</a>
	
				<form method="post" id="create_group" style="display: none;">
					<p>
