...
<?php if ($_GET['msg']): ?>
<div class='error_message bug_form_error'><?php echo htmlspecialchars($_GET['msg']) ?></div>
<?php elseif ($POD->error_msg) : ?>
<div class='error_message bug_form_error'><?php echo htmlspecialchars($POD->error_msg) ?></div>
<?php endif ?>
<ul id="bug_tabs">
	<? if (!$doc->saved()) { ?>
